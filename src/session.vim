...
set ruler
set runtimepath=~/.vim,~/.vim/pack/plugins/start/kotlin-vim,~/.vim/plugged/gruvbox,~/.vim/plugged/dracula,~/.vim/plugged/vim-js,~/.vim/plugged/vim-jsx-pretty,~/.vim/plugged/nerdtree,~/.vim/plugged/goyo.vim,~/.vim/plugged/vim-latex-live-preview,~/.vim/plugged/vim-instant-markdown,/var/lib/vim/addons,/etc/vim,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vimfiles/after,/etc/vim/after,/var/lib/vim/addons/after,~/.vim/plugged/dracula/after,~/.vim/plugged/vim-jsx-pretty/after,~/.vim/after
set shiftwidth=4
set showbreak=>
set splitbelow
set splitright
...
silent only
silent tabonly
cd ~/Desktop/WebDev/react/job_assessments/hive_dropdown/src
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 75 + 137) / 274)
exe 'vert 2resize ' . ((&columns * 98 + 137) / 274)
exe 'vert 3resize ' . ((&columns * 99 + 137) / 274)
argglobal
balt dropDown.jsx
setlocal keymap=
setlocal noarabic
...
setlocal breakindentopt=shift:2,min:20,sbr
setlocal bufhidden=
setlocal buflisted
setlocal buftype=
setlocal nocindent
...
wincmd w
argglobal
if bufexists("dropDown.jsx") | buffer dropDown.jsx | else | edit dropDown.jsx | endif
balt index.jsx
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 31 - ((0 * winheight(0) + 29) / 59)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 31
...
wincmd w
argglobal
if bufexists("index.jsx") | buffer index.jsx | else | edit index.jsx | endif
balt dropDown.jsx
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
exe 'vert 3resize ' . ((&columns * 99 + 137) / 274)
tabnext
edit ../../../../html_css_js/singlestore/style.css
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
argglobal
balt ../../../../html_css_js/singlestore/script.js
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("../../../../html_css_js/singlestore/script.js") | buffer ../../../../html_css_js/singlestore/script.js | else | edit ../../../../html_css_js/singlestore/script.js | endif
balt ../../../../html_css_js/singlestore/style.css
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
badd +16 index.css
badd +20 index.jsx
badd +67 dropDown.css
badd +0 dropDown.jsx
badd +61 ../../../../html_css_js/singlestore/index.html
badd +0 ../../../../html_css_js/singlestore/style.css
badd +0 ../../../../html_css_js/singlestore/script.js
